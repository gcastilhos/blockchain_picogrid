...
<div class="house">
  ...
  <table class="house-table" :class="{'bg-red': active && blocks > 1 }">
    <tr>
    ...
    <tr>
      ...
      <td class="label dark-blue">Nonce</td>
      <td class="text">
    ...
    <tr>
      <td class="label big-font">Event<br/>Data</td>
      <td class="text" colspan="3">
  ...
  <table class="no-border">
    <tr>
      ...
      <td class="text"> 
        <input class="hash" :class="{'bg-red': active}" disabled="true" type="text" v-model="originalHash" />
      </td>
    </tr>
  </table>
</div>
